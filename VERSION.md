...
1. **Demo 01: Bicep Quickstart** (14 files)
   ...
   - 78% time savings (45 min → 10 min)

2. **Demo 02: PowerShell Automation** (11 files)
   - VM provisioning automation
   - Bulk operations & compliance scanning
   - 75% time savings (60 min → 15 min)

3. **Demo 03: Azure Arc Onboarding** (10 files)
   - 500-server hybrid onboarding
   - SQL Server Arc discovery
   - 90% time savings (80 hrs → 8 hrs)

4. **Demo 04: Troubleshooting Assistant** (9 files)
   - AI-powered diagnostics
   - Natural language to KQL
   - 73% time savings (30 min → 8 min)

5. **Demo 05: Documentation Generator** (10 files)
   - Architecture diagrams (Mermaid)
   - Runbooks from infrastructure
   - 78% time savings (90 min → 20 min)

6. **Demo 06: Azure Specialization Prep** (15 files)
   - Audit evidence generation
   - Infrastructure + Database Migration specialization
   - 83% time savings (60 hrs → 10 hrs)

7. **Demo 07: Four-Agent Workflow** (7 files) 🆕
   - Complete architecture to code workflow
   - HIPAA-compliant patient portal scenario
