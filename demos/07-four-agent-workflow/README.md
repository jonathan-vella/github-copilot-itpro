...
- Custom agents configured (see [FOUR-MODE-WORKFLOW.md](../../resources/copilot-customizations/FOUR-MODE-WORKFLOW.md))
...
### Documentation
- [Four-Agent Workflow Guide](../../resources/copilot-customizations/FOUR-MODE-WORKFLOW.md)
