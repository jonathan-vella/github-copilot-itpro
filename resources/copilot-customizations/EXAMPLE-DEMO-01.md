...
```bash
cd scenarios/S01-bicep-baseline/solution
...
Looking at `scenarios/S01-bicep-baseline/solution/network.bicep`:
...
cd github-copilot-itpro/scenarios/S01-bicep-baseline/solution
