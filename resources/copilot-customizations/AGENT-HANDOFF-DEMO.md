...
This demo showcases the **five-agent workflow** for Azure infrastructure development, demonstrating how custom agents work together through handoff buttons.
