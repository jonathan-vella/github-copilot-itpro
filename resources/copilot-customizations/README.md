...
|------|---------------------------|
| **01-bicep-quickstart** | `bicep-code-best-practices.instructions.md`<br>`bicep-implement.chatmode.md` |
| **02-powershell-automation** | `powershell-pester-5.instructions.md`<br>`devops-core-principles.instructions.md` |
| **03-azure-arc-onboarding** | `azure-principal-architect.chatmode.md`<br>`devops-core-principles.instructions.md` |
| **04-troubleshooting-assistant** | `azure-resource-health-diagnose.prompt.md` |
| **05-documentation-generator** | `documentation-writer.prompt.md` |
