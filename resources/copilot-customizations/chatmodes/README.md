...
- **@plan** (built-in) - Create implementation plans with cost estimates
...
📖 See [FIVE-MODE-WORKFLOW.md](../FIVE-MODE-WORKFLOW.md) for the complete agent-based workflow.
...
- See `resources/copilot-customizations/FIVE-MODE-WORKFLOW.md` for detailed workflow documentation
