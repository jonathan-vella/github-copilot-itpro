---
title: "ADR-0001: Five-Agent Workflow Adoption for Azure Infrastructure Development"
status: "Accepted"
date: "2025-11-17"
...
# ADR-0001: Five-Agent Workflow Adoption for Azure Infrastructure Development
...
Adopt a **five-agent workflow** integrating:

0. **Plan Agent (Built-in)** - Create implementation plans with cost estimates
1. **ADR Generator (Custom Agent)** - Document architectural decisions with structured ADRs
2. **Azure Principal Architect (Custom Agent)** - Provide WAF-based architectural guidance
3. **Bicep Planning (Custom Agent)** - Create machine-readable infrastructure plans
4. **Bicep Implementation (Custom Agent)** - Generate Bicep code from plans
...
- **IMP-004**: **Phase 4 (Week 2)**: Update S01 and S04 scenario scripts to showcase five-agent workflow
- **IMP-005**: **Partner Training**: Create quick reference card and agent selection flowchart for field personnel
...
- Enhanced demos showcase five-agent workflow
